...
import com.payment.arthpay.adapter.DMTCardAdapter;
...
public class DMTStatement extends AppCompatActivity {
    ...
    private void init() {
        ...
        btnFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(DMTStatement.this, "filter", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("DMT Statement");
                ...
                try {
                    ...
                    if (isFilterData) {
                        ...
                        url = new URL(Constents.URL.baseUrl + "api/android/transaction?apptoken=" +
                                ...
                                + SharedPrefs.getValue(DMTStatement.this, SharedPrefs.USER_ID) + "&type=" + type +
