...
public class WalletRequest extends AppCompatActivity {
    ...
    EditText edittext_amount, edittext_referenceno, etPin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_payment_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(WalletRequest.this, (view, year, monthOfYear, dayOfMonth) -> {
            ...
            public void onClick(View v) {
                if (AppManager.isOnline(WalletRequest.this)) {
                    if (selected_bank_id.equals("")) {
                        ...
                        Toast.makeText(WalletRequest.this, "Pin is required", Toast.LENGTH_SHORT).show();
                    } else {
                        String amount = edittext_amount.getText().toString();
                        String reference_no = edittext_referenceno.getText().toString();
                        String pin = etPin.getText().toString();
                        mSubmitPaymentRequest(amount, reference_no, pin);
                    }
                } else {
            ...
            protected String doInBackground(String... args) {
                ...
                try {
                    URL url = new URL(Constents.URL.baseUrl + "api/android/fundrequest?apptoken="
                            ...
                            + "&type=getfundbank&user_id=" + SharedPrefs.getValue(WalletRequest.this, SharedPrefs.USER_ID) +
    ...
    private void mSubmitPaymentRequest(final String amount, final String referenece_no, final String pin) {
        class getJSONData extends AsyncTask<String, String, String> {
            ...
            protected String doInBackground(String... args) {
                ...
                try {
                    URL url = new URL(Constents.URL.baseUrl + "api/android/fundrequest?apptoken=" +
                            ...
                            + selected_bank_id + "&paymode=" + selected_payment_mode_id + "&amount=" + amount +
                            "&ref_no=" + referenece_no
                            + "&pin=" + pin +
