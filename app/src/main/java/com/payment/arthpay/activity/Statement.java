...
import com.payment.arthpay.adapter.RechargeHistoryAdapter;
                        ...
                        if (jsonObject.has("statuscode")) {
                            ...
                            if (status.equalsIgnoreCase("UA")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    if (data.has("providertype"))
                                        item.setProvidertype(data.getString("providertype"));
                                    if (data.has("providername"))
                                        item.setProvidername(data.getString("providername"));
